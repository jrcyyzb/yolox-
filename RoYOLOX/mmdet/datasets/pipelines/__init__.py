...
from .loading import (LoadAnnotations, LoadImageFromFile, LoadImageFromWebcam,
                      LoadMultiChannelImageFromFiles, LoadProposals,LoadPolygonAnnotations)
...
__all__ = [
    ...
    'Transpose', 'Collect', 'DefaultFormatBundle', 'LoadAnnotations','LoadPolygonAnnotations',
